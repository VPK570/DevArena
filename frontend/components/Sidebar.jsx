  ...
  return (
    <aside className="fixed left-0 top-14 h-[calc(100vh-3.5rem)] flex flex-col p-4 z-40 bg-[#0E0E11] border-r border-[#00F0FF]/15 w-64 hidden lg:flex">
      ...
      <nav className="flex-1 space-y-1">
        <Link className="flex items-center gap-3 bg-[#00F0FF] text-[#131316] font-bold p-2 mb-1" href="/">
          <span className="material-symbols-outlined text-sm">grid_view</span>
          <span className="font-headline text-[0.75rem] tracking-widest uppercase">DASHBOARD</span>
        </Link>
        <a className="flex items-center gap-3 text-[#B3B7CF] hover:text-[#00F0FF] hover:bg-[#00F0FF]/5 p-2 transition-colors" href="#">
          <span className="material-symbols-outlined text-sm">leaderboard</span>
          <span className="font-headline text-[0.75rem] tracking-widest uppercase">RANKINGS</span>
        </a>
        <a className="flex items-center gap-3 text-[#B3B7CF] hover:text-[#00F0FF] hover:bg-[#00F0FF]/5 p-2 transition-colors" href="#">
        ...
        <a className="flex items-center gap-3 text-[#B3B7CF] hover:text-[#00F0FF] hover:bg-[#00F0FF]/5 p-2 transition-colors" href="#">
          ...
          <span className="font-headline text-[0.75rem] tracking-widest uppercase">STREAMS</span>
        </a>
        <a className="flex items-center gap-3 text-[#B3B7CF] hover:text-[#00F0FF] hover:bg-[#00F0FF]/5 p-2 transition-colors" href="#">
          <span className="material-symbols-outlined text-sm">description</span>
          <span className="font-headline text-[0.75rem] tracking-widest uppercase">SYSTEM_LOG</span>
        </a>
      </nav>

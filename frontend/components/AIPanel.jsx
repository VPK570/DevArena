...
export default function AIPanel({ type, loading, content, onClose }) {
  return (
    <div
      className={`fixed right-0 top-14 bottom-0 w-[400px] z-[60] 
    ...
    >
      {/* Header */}
      <div
        className="h-12 border-b border-[#00F0FF]/15 flex items-center 
      ...
      <div className="flex-1 overflow-y-auto p-6 scrollbar-thin">
        {loading ? (
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              <span
                className="bg-purple-500/20 text-purple-400 px-2 py-0.5 
            ...
            <div>
              ...
              <div className="space-y-3">
                {content?.lines?.map((item, idx) => (
                  <div
                    key={idx}
                    className="bg-[#131316] p-4 border-r-2 border-amber-500/10 hover:border-amber-500/40 transition-all group"
                  >

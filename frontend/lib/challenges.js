...
export default function Counter() {
  ...
  },
  {
    ...
    difficulty: 'Medium',
    shortDescription: 'Implement a list where users can add and remove items dynamically.',
...
export default function TodoList() {
  ...
  },
  {
    ...
    difficulty: 'Hard',
    shortDescription: 'Replicate a complex grid-based dashboard layout using pure CSS.',

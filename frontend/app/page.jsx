    ...
    <main className="lg:ml-64 pt-14 min-h-screen">
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden border-b border-[#00F0FF]/15">
        ...
        <div className="relative z-10 text-center">
          <div className="text-[10px] text-[#00F0FF] font-headline tracking-[0.5em] mb-4 opacity-70">
            {isAuthenticated
              ? `WELCOME_BACK_${profile?.username?.toUpperCase()}`
              : "SYSTEM_ACCESS_GRANTED"}
          </div>
          <h1 className="text-7xl md:text-9xl font-headline font-black tracking-tighter glitch-text text-white leading-none">
            BATTLE-FRONT
          </h1>
          <p className="mt-6 text-[#B3B7CF] font-body max-w-xl mx-auto px-4 uppercase">
            THE PREMIER CODING COMBAT ARENA. INFILTRATE. OPTIMIZE. DOMINATE.
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link
              href={
                activeChallenges.length > 0
                  ? `/challenge/${activeChallenges[0].slug || activeChallenges[0].id}`
                  : "#"
              }
              className="group relative px-8 py-3 bg-transparent border-2 border-[#00F0FF] text-[#00F0FF] font-headline font-bold tracking-widest overflow-hidden transition-all hover:bg-[#00F0FF] hover:text-[#131316]"
            >
            ...
            {!isAuthenticated && (
              <Link
                href="/login"
                className="px-8 py-3 border border-[#B3B7CF]/30 text-[#B3B7CF] font-headline font-bold tracking-widest hover:border-[#00F0FF] transition-all"
              >
                AUTHENTICATE
              </Link>
            )}
      ...
      <div className="bg-surface-container-lowest border-b border-[#00F0FF]/15 h-8 overflow-hidden flex items-center">
        <div className="whitespace-nowrap flex items-center gap-8 animate-marquee font-body text-[10px] text-[#00F0FF]/60 uppercase tracking-widest">
          ...
          <span>
            [ALERT] CRITICAL_VULNERABILITY DETECTED IN PATHFINDING_MODULE...
          </span>
          <span>[LOG] CLAN_VOID SECURED #1 POSITION...</span>
          {isAuthenticated && (
            <span>
              [SESSION] OPERATOR_{profile?.username?.toUpperCase()} LOADED...
            </span>
          )}
        </div>
      </div>
      ...
      <div className="p-8 grid grid-cols-1 xl:grid-cols-4 gap-8">
        ...
        <div className="xl:col-span-3 space-y-8">
          <div className="flex justify-between items-end border-b border-[#00F0FF]/15 pb-4">
            <h2 className="font-headline text-2xl font-bold tracking-widest text-white uppercase">
              ACTIVE_ARENAS{" "}
              <span className="text-[#00F0FF] text-sm ml-2">
            ...
            <div className="flex gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-[#B3B7CF] uppercase">
                  SERVER_REGION: US_EAST
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {activeChallenges.map((challenge) => (
              ...
              >
                <div
                  className={`absolute top-0 right-0 p-2 text-[8px] font-headline opacity-40 uppercase ${challenge.difficulty === "Hard" || challenge.difficulty === "hard" ? "text-[#FF003C]" : "text-[#00F0FF]"}`}
                >
                ...
                <p className="text-xs text-[#B3B7CF] font-body mb-6 leading-relaxed flex-grow">
                ...
                <div className="mt-auto flex justify-between items-center">
                  <span
                    className={`${challenge.difficulty === "Hard" || challenge.difficulty === "hard" ? "bg-[#FF003C]/20 text-[#FF003C]" : "bg-[#00F0FF]/10 text-[#00F0FF]"} px-2 py-1 text-[9px] font-headline uppercase`}
                  >
                    {challenge.difficulty} // 100XP
                  </span>
                  <span
                    className={`text-[10px] font-body uppercase ${challenge.difficulty === "Hard" || challenge.difficulty === "hard" ? "text-[#FF003C] font-bold" : "text-[#B3B7CF]"}`}
                  >
                    ACTIVE
                  </span>
                </div>
          ...
          <div className="mt-12">
            <h2 className="font-headline text-sm font-bold tracking-widest text-[#B3B7CF] mb-4 uppercase">
        ...
        <div className="space-y-6">
          <div className="bg-surface-container-highest border border-[#00F0FF]/15 p-6 space-y-8">
            <h2 className="font-headline text-xs font-bold tracking-widest text-[#00F0FF] uppercase">
              USER_VITALS_v4.2
            </h2>
            <div>
              <div className="flex justify-between items-end mb-2">
                <span className="font-headline text-[10px] text-[#B3B7CF] uppercase">
                  CURRENT_ELO
                </span>
                ...
                <div
                  ...
                  style={{
                    width: isAuthenticated
                      ? `${Math.min((profile?.elo_rating / 3000) * 100, 100)}%`
                      : "0%",
                  }}
                ></div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-3 bg-[#131316] border border-[#00F0FF]/5">
                <div className="text-[9px] font-headline text-[#B3B7CF] mb-1 uppercase">
                  STREAK
                </div>
                <div className="text-lg font-headline text-white uppercase">
                  {isAuthenticated ? "1_DAY" : "0_DAYS"}
                </div>
              </div>
              <div className="p-3 bg-[#131316] border border-[#00F0FF]/5">
                <div className="text-[9px] font-headline text-[#B3B7CF] mb-1 uppercase">
                ...
                <div className="text-lg font-headline text-white">
                  {isAuthenticated ? "98.2%" : "0.0%"}
                </div>
              </div>
            </div>
          ...
          <div className="p-6 bg-[#131316] border border-[#00F0FF]/15">
            <h3 className="font-headline text-[10px] text-[#B3B7CF] tracking-widest mb-4 uppercase">
              NEAREST_THREATS
            </h3>
      ...
      <footer className="bg-[#131316] border-t border-[#00F0FF]/15 p-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="text-[10px] font-headline text-[#B3B7CF] tracking-widest uppercase">
          © 2024 BATTLE-FRONT // ALL RIGHTS RESERVED //{" "}
          <span className="text-[#00F0FF]">ENCRYPTED_SESSION</span>
        </div>
        <div className="flex gap-6">
          <a
            className="text-[10px] font-headline text-[#B3B7CF] hover:text-[#00F0FF] transition-colors uppercase"
            href="#"
          >
            SECURITY_PROTOCOL
          </a>
